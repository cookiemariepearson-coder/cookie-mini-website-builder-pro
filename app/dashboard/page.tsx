...
export default function DashboardPage() {
  return <main className="container section">
    <nav className="nav">
      ...
      <div className="navlinks"><Link href="/builder">Builder</Link><Link href="/customer">Customer</Link><Link href="/video-studio">AI Video Studio</Link><Link href="/admin">Admin</Link><Link href="/">Home</Link></div>
    </nav>
    <section className="card">
      ...
      <div className="grid cards3">
        ...
        <div className="card"><h3>AI Video Studio</h3><p>Create promo video scripts, captions, and AI prompts for customer websites, TikTok, Facebook, and Instagram.</p><Link className="btn gold" href="/video-studio">Open AI Video Studio</Link></div>
