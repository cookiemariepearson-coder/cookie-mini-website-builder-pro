...
export const templates = {
  local: {
    ...
    art: { icon: '🏪', label: 'Local service hub', details: 'Service area • Booking • Contact' },
    services: [
  ...
  restaurant: {
    ...
    art: { icon: '🍽️', label: 'Signature flavor board', details: 'Menu • Recipes • Orders' },
    services: [
  ...
  realestate: {
    ...
    art: { icon: '🏘️', label: 'Property trust panel', details: 'Listings • Investors • Leads' },
    services: [
  ...
  wellness: {
    ...
    art: { icon: '🌿', label: 'Wellness journey card', details: 'Guides • Trackers • Calm' },
    services: [
  ...
  portfolio: {
    ...
    art: { icon: '🎬', label: 'Creator spotlight wall', details: 'Projects • Portfolio • Booking' },
    services: [
  ...
  nonprofit: {
    ...
    art: { icon: '🤝', label: 'Community impact board', details: 'Mission • Programs • Support' },
    services: [
